var mc_do={container:""};
$(function(){
    mc_do.container = "#import-mcdonald";

    $(mc_do.container).CSVToTable('data/24_02_2012-Venez_comme_vous_etes-Sheet.csv', { loadingImage: 'img/loading.gif',tableClass:'table table-striped table-bordered table-condensed', startLine: 1, separator:",",headers: [/*' ',*/ 'id', 'Name', 'Firstname', 'mail', 'Date','ip origin','Picture'] }).bind("loadComplete",function() { 
            $(mc_do.container).find('TABLE').tablesorter();
